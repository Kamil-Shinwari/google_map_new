...
class _MyAppState extends State<MyApp> {
  var check=true;
  // Future<bool> checkCred()async{
  //   QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('admin').where('uid',isEqualTo: FirebaseAuth.instance.currentUser!.uid).get();
  //   print('query value is: '+querySnapshot.docs.length.toString());
